...
import { Geist, Geist_Mono, Anton, Montserrat } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="es"
      className={`${geistSans.variable} ${geistMono.variable} ${anton.variable} ${montserrat.variable} h-full antialiased`}
    >
